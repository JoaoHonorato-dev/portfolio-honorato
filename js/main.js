...
(function () {
  ...
  const translations = {
    pt: {
      ...
      'about.card3.text': 'Meu objetivo é me tornar um desenvolvedor especialista em soluções escaláveis e inteligentes. Atualmente, foco em dominar o ecossistema Next.js e aprofundar minha expertise na integração de IAs (Gemini API). Busco ambientes que valorizem a inovação tecnológica e as melhores práticas de engenharia de software, onde eu possa crescer junto com a equipe.',
      'about.card4.title1':'Stack Principal',
      'about.card4.title2':'Tecnologias em Evolução', 
      'about.image1': 'Imagem opcional',
      'projects.title': 'Projetos',
      'projects.item1.title': 'Gestão de Veículos',
      'projects.item1.desc': 'Aplicação desenvolvida com Next.js e React para integrar dados de rastreamento veicular em tempo real, oferecendo monitoramento, análises e dashboards intuitivos para tomada de decisão.',      'projects.item2.title': 'Nome do Projeto 2',
    ...
    en: {
      ...
      'about.card3.text': 'My goal is to become an expert developer specializing in scalable and intelligent solutions. Currently, I am focused on mastering the Next.js ecosystem and deepening my expertise in AI integration (Gemini API). I am looking for environments that value technological innovation and software engineering best practices, where I can grow together with the team.',
      'about.card4.title1':'Main Stack',
      'about.card4.title2':'Learning', 
      'about.image1': 'Optional image',
      'projects.title': 'Projects',
      'projects.item1.title': 'Vehicle Management',
      'projects.item1.desc': 'Application built with Next.js and React to integrate real-time vehicle tracking data, providing monitoring, analytics, and intuitive dashboards to support decision-making.',      'projects.item2.title': 'Project Name 2',
